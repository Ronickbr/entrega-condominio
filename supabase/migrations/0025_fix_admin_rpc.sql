-- ============================================================
-- Migration: Re-create wipe_database and seed_mockup_data correctly
-- ============================================================

drop function if exists public.wipe_database();
drop function if exists public.seed_mockup_data();
...
begin
  ...
  -- Delete transactional and operational data safely with WHERE true
